...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center p-4">
      ...
      {/* Modal Dialog */}
      <div
        className={`relative w-full ${maxWidthClasses[maxWidth]} bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden z-10 animate-in zoom-in-95 duration-200`}
      >
        {/* Header */}
